...
public class Vehicle {
    ...
    Vehicle(String make, String model, int yearOfMan, int maxSeats, String serialNo, String city,String maintenanceDate, long currentTimeMillis,boolean isAvaliable, String LicencePlate) 
    {
